...
public class Galleta {
    ...
    static void repartirGalletasBack(int[] vectorGalletas, int nivel, int[] solucion, int[] mejorSolucion,
            int maxSolucion, Entero maxMejorSolucion) {
